<div id="sidebar" class="w-[270px] flex flex-col shrink-0 min-h-screen justify-between p-[30px] border-r border-[#EEEEEE] bg-[#FBFBFB]">
    <div class="w-full flex flex-col gap-[30px]">
        ...
        <ul class="flex flex-col gap-3">
            ...
            <li>
                <a href="{{ route('dashboard.courses.index') }}" class="p-[10px_16px] flex items-center gap-[14px] rounded-full h-11 transition-all duration-300 hover:bg-[#2B82FE] {{ request()->routeIs('dashboard.courses.index') ? 'bg-[#2B82FE]' : '' }}">
                    <div>
                        <img src="{{ asset('images/icons/note-favorite.svg')}}" alt="icon">
                    </div>
                    <p class="font-semibold transition-all duration-300 {{ request()->routeIs('dashboard.courses.index') ? 'text-white' : '' }} hover:text-white">Courses</p>
                </a>
            </li>
